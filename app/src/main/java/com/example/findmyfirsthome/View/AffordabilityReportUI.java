...
import com.example.findmyfirsthome.Presenter.AffordabilityReportController;
...
public class AffordabilityReportUI extends AppCompatActivity {
    ...
    private void takeScreenshot(View view) {
        ...
        try {
            ...
            Bitmap bitmap = Bitmap.createBitmap(v1.getDrawingCache(),0,((int)(v1.getDrawingCache().getHeight()*0.11)),v1.getDrawingCache().getWidth(),((int)(v1.getDrawingCache().getHeight()*0.45)));
